...
import (
	...
	"github.com/ethereum/go-ethereum/accounts/abi/bind" // Added missing import
...
func main() {
	...
	deployContracts(privateKeyHex, l1RPCURL)
...
func sendEther(client *ethclient.Client, privateKey *ecdsa.PrivateKey, toAddress string, amount *big.Int) error {
	...
	// Corrected: Removed the HomesteadSigner from the arguments
